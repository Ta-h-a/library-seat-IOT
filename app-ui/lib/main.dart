                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TableOverviewPage(userRole: 'staff'),
                      ),
                    );
                  },
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TableOverviewPage(userRole: 'customer'),
                      ),
                    );
                  },
                  style: ElevatedButton.styleFrom(
...
class _TableOverviewPageState extends State<TableOverviewPage> {
  ...
  List<TableData> get _allTables => [
        TableData('T1', Colors.green.shade400, Icons.check_circle_outlined, 'Available'),
        ...
        TableData('T4', Colors.orange.shade400, Icons.cleaning_services_outlined, 'Needs Cleaning'),
        TableData('T5', Colors.green.shade400, Icons.check_circle_outlined, 'Available'),
        TableData('T6', Colors.red.shade400, Icons.person_outline, 'Occupied'),
        TableData('T7', Colors.green.shade400, Icons.check_circle_outlined, 'Available'),
  ...
  List<TableData> get _filteredTables {
    ...
    return _allTables.where((table) => table.status == _selectedFilter).toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final tables = _filteredTables.map((table) {
      final isRectangular = random.nextDouble() < 0.3;
      return TableCard(
